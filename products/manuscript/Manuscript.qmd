...
```{r}
#| label: fig-result
#| fig-cap: "Weight and Age."
#| echo: FALSE
knitr::include_graphics(here("results","scatterplot_weight_v_age.png"))
```
...
```{r}
#| label: fig-result2
#| fig-cap: "Height and Smoking Status."
#| echo: FALSE
knitr::include_graphics(here("results","boxplot_smoking_v_height.png"))
```
